...
class ProductBase(models.Model):
	...
	calories = models.DecimalField(decimal_places=2, null=False, blank=False)
	saturated_fat_percent = models.DecimalField(decimal_places=2, null=False, blank=False)
	sugar_percent = models.DecimalField(decimal_places=2, null=False, blank=False)
	description = models.TextField(blank=True, null=True)
...
class Product(models.Model):
	product_base = models.ForeignKey(ProductBase,
		null=False,
		blank=False,
		verbose_name=_("ProductBase"),
		on_delete=models.CASCADE)
	establishment = models.ForeignKey(ProductBase,
		null=False,
		blank=False,
